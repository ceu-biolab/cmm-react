...
const AspergillusSearch = () => {
  ...
  useEffect(() => {
    setSearchData((prev) => ({
      ...prev,
      databases: prev.databases.includes("Aspergillus")
        ? prev.databases
        : [...prev.databases, "Aspergillus"],
    }));
  }, []);
        ...
        <form onSubmit={handleSubmit} className="search-form">
          ...
          <div className="row">
            <div className="column">
              ...
              <div className="row">
                ...
                <div className="inner-column">
                    ...
                    {["All", "CHNOPS", "CHNOPS+CL"].map((option) => (
                      <label key={option} className="box">
                        <input
                          ...
                          value={option}
                          checked={searchData.chemicalAlphabet === option}
                          onChange={handleChange}
                        />
                        {option.replace(/-/g, " ")}
                      </label>
                  ...
                  {/* Deuterium checkbox */}
                  <div className="checkboxes-deuterium">
                    <label className="radio-deuterium">
            ...
            <div className="column">
              ...
              <div className="checkboxes checkboxes-asp-search">
                {[
